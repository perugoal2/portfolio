...
slug: ai-pdf-reader
date: 2026-04-17
summary: Built a local-first AI PDF Reader that lets users upload documents, retrieve grounded answers, generate study guides, and run as both a web app and offline desktop experience.
tagline: A private, local-first document AI product with grounded retrieval, desktop packaging, and strong UX.
featured: true
tags:
  - AI Engineering
...
capabilities:
  ...
  - Desktop packaging
  - Threat modeling
architectureImage: /diagrams/ai-pdf-reader-architecture.svg
threatModelImage: /diagrams/ai-pdf-reader-threat-model.svg
githubUrl: https://github.com/perugoal2/AI-PDF-Reader
---
# Context
